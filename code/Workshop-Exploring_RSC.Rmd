...
cat(full_text_test) # print the whole thing
```
...
custom_stopwords <- c("fig", "page", "pp", "vol", "etc", "viz", "mr", "dr", "prof", "#151",
                  "#183", "#169", "also", "upon", "one", "two", "three", "four", "five", "six", "seven",
...
## 4. Authorship Metadata: Individual vs Collaborative Work
...
## 5. Combined Metadata: Complex Questions
...
*Methodological Power:* This represents the full potential of metadata-driven analysis—the ability to ask complex, multi-faceted questions that would be impossible with any single dimension of context.
...
### Advanced Combined Analysis Ideas:
...
**Methodological Insight:** Network metadata reveals the social structure underlying scientific knowledge production. Different communities of scientists may develop distinct vocabularies, research methods, or ways of describing phenomena—even when studying related topics.
...
What we've tried to demonstrate

**1. Baseline (No Metadata Context):**

Capability: Reveals general vocabulary patterns and surface-level themes
Critical Limitation: No interpretive context—we see patterns but cannot explain them

**2. Temporal metadata:**

New Capabilities: Historical analysis, tracking conceptual evolution, identifying emergence/decline patterns
Research Questions Unlocked: When did concepts emerge? How did language evolve? What disappeared over time?

**3. Topics:**

New Capabilities: Disciplinary analysis, field-specific vocabularies, interdisciplinary boundary detection
Research Questions Unlocked: How do fields use language differently? What terminology is discipline-specific? Where do fields overlap?

**4. Authorship:**

New Capabilities: Collaboration analysis, individual vs. collective discourse patterns, social organisation effects
Research Questions Unlocked: How does collaboration affect language? Do teams write differently than individuals? How does social structure influence content?

**5. Combining metadata:**

New Capabilities: Complex, multi-dimensional analysis, interaction effects, layered contextual investigation
Research Questions Unlocked: How do multiple factors interact? What emerges only from combined analysis? How do different contexts layer together?

**6. Network data:**

New Capabilities: Social analysis of knowledge, community-specific language patterns, intellectual network mapping
Research Questions Unlocked: How do scholarly communities differ? What language is shared vs. specialised? How do networks influence terminology?

## The Key Claim

**Metadata fundamentally determines what research questions are possible to ask and answer when using text.**

Each type of metadata creates new analytical possibilities. This principle extends far beyond historical corpora:

- Social Media Analysis: Timestamps, user profiles, location data, network connections
- News Corpora: Publication dates, outlets, authors, topics, geographic focus
- Legal Documents: Court levels, case types, dates, jurisdictions, outcomes
- Corporate Communications: Department, hierarchy level, meeting types, project codes
- Academic Literature: Disciplines, citation networks, author affiliations, venue types
